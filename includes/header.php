    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo" style="color: black; font-weight: bold;"> <a href="index.php"><img src="assets/images/logo.jpg" alt="image" width="50px" height="50px"  /> </a>CarRentalAgency </div>
        </div>
